...
namespace Empire_ERP.Controllers
{
    ...
    {
        public ISalesContractService _salesContractService { get; set; }
        public IPeriodService _periodService { get; set; }
        private readonly IWebHostEnvironment _hostingEnvironment;
        public SalesContractController(ISalesContractService salesContractService, IMenuService menuService, IPeriodService periodService, IWebHostEnvironment hostingEnvironment,IBaseService baseService) : base(menuService,baseService)
        {
        ...
        [HttpGet]
        public JsonResult GetSalesContracts()
        {
            try
            {
                var data = _salesContractService.QuickSearch(CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpGet]
        public JsonResult GetSalesContractByCode(int code)
        {
            try
            {
                var data = _salesContractService.GetSalesContractByCode(code, CommonHelper.GetValues(HttpContext));
                var detailData = _salesContractService.GetSalesContractDetailByCode(code, CommonHelper.GetValues(HttpContext));
        ...
        [HttpGet]
        public JsonResult GetSalesContractDetailByCode(int code)
        {
            try
            {
                var data = _salesContractService.GetSalesContractDetailByCode(code, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public JsonResult Save(CustomSalesContract modelRecord)
        {
            try
            {
                var data = _salesContractService.Save(modelRecord, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult Delete(int code)
        {
            try
            {
                var data = _salesContractService.Delete(code, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public JsonResult DeleteSalesContractDetailByCode(int code)
        {
            try
            {
                var data = _salesContractService.DeleteSalesContractDetailByCode(code, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult GetSodaBookFeedingDetail()
        {
            try
            {
                var data = _salesContractService.GetSodaBookFeedingDetail(CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> SaveImage()
        {
            ...
            try
            {
                ...
                {
                    string uploadsFolder = Path.Combine(_hostingEnvironment.WebRootPath, "Client", "uploads", "SalesContract");
                    ...
                    response.msgType = 1;
                    response.data = $"/Client/uploads/SalesContract/{uniqueFileName}"; // Return file path
                }
                else
                {
