...
namespace Empire_ERP.Controllers
{
    ...
    {
        public ICashReceiptVoucherService _cashReceiptVoucherService { get; set; }
        private readonly IWebHostEnvironment _hostingEnvironment;
        public IPeriodService _periodService { get; set; }
        public CashReceiptVoucherController(IMenuService menuService, ICashReceiptVoucherService cashReceiptVoucherService, IWebHostEnvironment hostingEnvironment, IPeriodService periodService,IBaseService baseService) : base(menuService,baseService)
        {
            _cashReceiptVoucherService = cashReceiptVoucherService;
        ...
        public JsonResult GetBookTypes()
        {
            try
            {
                var data = _cashReceiptVoucherService.GetChartOfAccounts(CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        //[HttpPost]
        //public JsonResult GetCashReceiptVouchers(int skip = 0, int take = 12, string sort = null, string filter = null, string group = null)
        //{
        //    try
        //    {
        //        var data = _cashReceiptVoucherService.QuickSearch(CommonHelper.GetValues(HttpContext), skip, take, filter, group, sort);
        //        return Json(data);
        //    }
        //    catch (Exception ex)
        //    {
        ...
        [HttpGet]
        public JsonResult GetCashReceiptVouchers()
        {
            try
            {
                var data = _cashReceiptVoucherService.QuickSearch(CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public JsonResult Save(List<CashReceiptVoucher> modelRecord)
        {
            try
            {
                var data = _cashReceiptVoucherService.Save(modelRecord, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpGet]
        public JsonResult GetCashReceiptVoucherByCode(int code)
        {
            try
            {
                var data = _cashReceiptVoucherService.GetCashReceiptVoucherByCode(code, CommonHelper.GetValues(HttpContext));
                var detailData = _cashReceiptVoucherService.GetCashReceiptVoucherDetailsByCode(code, CommonHelper.GetValues(HttpContext));
        ...
        [HttpGet]
        public JsonResult GetCashReceiptVoucherDetailsByCode(int code)
        {
            try
            {
                var data = _cashReceiptVoucherService.GetCashReceiptVoucherDetailsByCode(code, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult Delete(int code)
        {
            try
            {
                var data = _cashReceiptVoucherService.Delete(code, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult CopyRecord(CopyRecord record)
        {
            try
            {
                var data = _cashReceiptVoucherService.CopyRecord(record, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public JsonResult DeleteCashReceiptVoucherDetailByCode(int tranID, int code)
        {
            try
            {
                var data = _cashReceiptVoucherService.DeleteCashReceiptVoucherDetailByCode(tranID, code, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        private string GenerateReport(CashReceiptRDLCReport model)
        {
            ...
            try
            {
                if (model != null && model.TRAN_ID > 0 && model.MD_ID > 0)
                {
                    ...
                    var responseMessage = _cashReceiptVoucherService.GetDataForReport(model, reportDetails, CommonHelper.GetValues(HttpContext));
