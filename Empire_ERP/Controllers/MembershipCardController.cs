...
namespace Empire_ERP.Controllers
{
    ...
    {
        public IMembershipCardService _membershipCardService { get; set; }
        private readonly IWebHostEnvironment _hostingEnvironment;
        public IPeriodService _periodService { get; set; }
        public MembershipCardController(IMembershipCardService chartOfAccountService, IMenuService menuService, IWebHostEnvironment hostingEnvironment, IPeriodService periodService,IBaseService baseService) : base(menuService,baseService)
        {
            _membershipCardService = chartOfAccountService;
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.CardType = DropdownService.GetCardType();
        ...
        [HttpGet]
        public JsonResult GetMembershipCards()
        {
            var data = _membershipCardService.GetMembershipCards(CommonHelper.GetValues(HttpContext));
            return Json(data);
        }
        ...
        public JsonResult GetAccountsForTreeView()
        {
            try
            {
                var data = _membershipCardService.GetAccountsForTreeView(CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult QuickSearch()
        {
            try
            {
                var data = _membershipCardService.QuickSearch(CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpGet]
        public JsonResult MembershipCardByid(int id)
        {
            var data = _membershipCardService.GetMembershipCardById(id, CommonHelper.GetValues(HttpContext));
            return Json(data);
        }
        ...
        public JsonResult GenerateCardNo()
        {
            try
            {
                var data = _membershipCardService.GenerateCardNo(CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public JsonResult Save(MembershipCard model)
        {
            try
            {
                var data = _membershipCardService.Save(model, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult Delete(int id)
        {
            try
            {
                var data = _membershipCardService.Delete(id, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public JsonResult GetPrintReport(MembershipCardReport model)
        {
        ...
        private string GenerateReport(MembershipCardReport model)
        {
            var filePath = "";
            try
            {
                if (model != null && model.TRAN_ID > 0 && model.MD_ID > 0)
                {
                    ...
                    var responseMessage = _membershipCardService.GetDataForReport(model, reportDetails, CommonHelper.GetValues(HttpContext));
                    if (responseMessage.msgType != 1)
                    {
                        return "";
                    }
                    var reportData = (MembershipCardReport)responseMessage.data;
                    ...
                    using (LocalReport report = new LocalReport())
                    {
                        ...
                        using (var stReader = new StreamReader(path))
                        {
                            ...
                            parameter16, parameter17, parameter18, parameter19, parameter20, parameter21, parameter22, parameter23, parameter24, parameter25, parameter26 });
                                ...
                                byte[] file;
                                string uploadsFolder = Path.Combine(_hostingEnvironment.WebRootPath, @"Client\MembershipCard");
                                ...
                                if (report.IsReadyForRendering)
                                {
                                    ...
                                    filePath = $"/Client/MembershipCard/{filePath}";
                                }
                            }
                        }
                    }
