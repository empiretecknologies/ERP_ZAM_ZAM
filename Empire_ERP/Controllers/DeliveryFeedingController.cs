...
namespace Empire_ERP.Controllers
{
    [CheckSession]
    [ExtractMenuCode]
    public class DeliveryFeedingController : BaseController
    {
        public IDeliveryFeedingService _deliveryFeedingService { get; set; }
        public IBranchService _branchService { get; set; }
        public IMenuRepository _menuRepository { get; set; }
        private readonly IWebHostEnvironment _hostingEnvironment;
        public IPeriodService _periodService { get; set; }
        public DeliveryFeedingController(IMenuRepository menuRepository, IMenuService menuService, IBranchService branchService, IDeliveryFeedingService deliveryFeedingService, IWebHostEnvironment hostingEnvironment, IPeriodService periodService,IBaseService baseService) : base(menuService,baseService)
        {
        ...
        [HttpPost]
        public JsonResult Save(CustomDeliveryFeeding modelRecord)
        {
            try
            {
        ...
        [HttpPost]
        public JsonResult GetPrintReport(DeliveryFeedingReport model)
        {
        ...
        private string GenerateReport(DeliveryFeedingReport model)
        {
            var filePath = "";
            try
            {
