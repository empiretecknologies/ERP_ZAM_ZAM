...
namespace Empire_ERP.Controllers
{
    [CheckSession]
    [ExtractMenuCode]
    public class HRCandidateController : BaseController
    {
        public IHRCandidateService _HRCandidateService { get; set; }
        private readonly IWebHostEnvironment _hostingEnvironment;
        public IPeriodService _periodService { get; set; }
        public HRCandidateController(IHRCandidateService chartOfAccountService, IMenuService menuService, IWebHostEnvironment hostingEnvironment, IPeriodService periodService,IBaseService baseService) : base(menuService,baseService)
        {
        ...
        [HttpPost]
        public JsonResult Save(HRCandidate model)
        {
            try
            {
