...
namespace Empire_ERP.Controllers
{
    [CheckSession]
    [ExtractMenuCode]
    public class AttendanceMachineController : BaseController
    {
        ...
        public AttendanceMachineController(IMenuService menuService, IBranchService branchService, IAttendanceMachineService AttendanceMachineService, IWebHostEnvironment hostingEnvironment, ICompositeViewEngine viewEngine,IBaseService baseService) : base(menuService,baseService)
        {
