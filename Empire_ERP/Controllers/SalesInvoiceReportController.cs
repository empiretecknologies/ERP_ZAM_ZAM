...
namespace Empire_ERP.Controllers
{
    [ExtractMenuCode]
    [CheckSession]
    public class SalesInvoiceReportController : BaseController
    {
        public IPeriodService _periodService { get; set; }
        public ISalesInvoiceReportService _salesInvoiceReportService { get; set; }
        public ICompanyService _companyService { get; set; }
        public SalesInvoiceReportController(IMenuService menuService, IPeriodService periodService, ISalesInvoiceReportService salesInvoiceReportService, ICompanyService companyService,IBaseService baseService) : base(menuService,baseService)
        {
            _periodService = periodService;
            _salesInvoiceReportService = salesInvoiceReportService;
        ...
        public JsonResult GetReportTypes()
        {
            try
            {
                var data = _salesInvoiceReportService.GetReportTypes(CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public JsonResult GenerateReport(SalesInvoiceReport report)
        {
            try
            {
                var data = _salesInvoiceReportService.GetReportData(report, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
