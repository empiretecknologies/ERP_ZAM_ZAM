...
namespace Empire_ERP.Controllers
{
    [CheckSession]
    [ExtractMenuCode]
    public class PartyReceiptVoucherController : BaseController
    {
        public IPartyReceiptVoucherService _partyReceiptVoucherService { get; set; }
        public IPeriodService _periodService { get; set; }
        private readonly IWebHostEnvironment _hostingEnvironment;
        public PartyReceiptVoucherController(IMenuService menuService, IPartyReceiptVoucherService partyReceiptVoucherService, IPeriodService periodService, IWebHostEnvironment hostingEnvironment,IBaseService baseService) : base(menuService,baseService)
        {
            _partyReceiptVoucherService = partyReceiptVoucherService;
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.BookTypes = common.RoleType == "A"
                ? DropdownService.GetBookTypesForReceiptVoucher(0, common.Branch, 0, common)
                : DropdownService.GetBookTypesForReceiptVoucher(common.RoleID, common.Branch, common.ShowSelected, common);
        ...
        public JsonResult GetBookTypes()
        {
            try
            {
                var data = _partyReceiptVoucherService.GetChartOfAccounts(CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        //[HttpPost]
        //public JsonResult GetPartyReceiptVouchers(int skip = 0, int take = 12, string sort = null, string filter = null, string group = null)
        //{
        //    try
        //    {
        //        var data = _partyReceiptVoucherService.QuickSearch(CommonHelper.GetValues(HttpContext), skip, take, filter, group);
        //        return Json(data);
        //    }
        //    catch (Exception ex)
        //    {
        ...
        [HttpGet]
        public JsonResult GetPartyReceiptVouchers()
        {
            try
            {
                var data = _partyReceiptVoucherService.QuickSearch(CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public JsonResult Save(List<PartyReceiptVoucher> modelRecord)
        {
            try
            {
                var data = _partyReceiptVoucherService.Save(modelRecord, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpGet]
        public JsonResult GetPartyReceiptVoucherByCode(int code)
        {
            try
            {
                var data = _partyReceiptVoucherService.GetPartyReceiptVoucherByCode(code, CommonHelper.GetValues(HttpContext));
                var detailData = _partyReceiptVoucherService.GetPartyReceiptVoucherDetailsByCode(code, CommonHelper.GetValues(HttpContext));
        ...
        [HttpGet]
        public JsonResult GetPartyReceiptVoucherDetailsByCode(int code)
        {
            try
            {
                var data = _partyReceiptVoucherService.GetPartyReceiptVoucherDetailsByCode(code, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult Delete(int code)
        {
            try
            {
                var data = _partyReceiptVoucherService.Delete(code, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult CopyRecord(CopyRecord record)
        {
            try
            {
                var data = _partyReceiptVoucherService.CopyRecord(record, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public JsonResult DeletePartyReceiptVoucherDetailByCode(int tranID, int code)
        {
            try
            {
                var data = _partyReceiptVoucherService.DeletePartyReceiptVoucherDetailByCode(tranID, code, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        private string GenerateReport(CashReceiptRDLCReport model)
        {
            ...
            try
            {
                if (model != null && model.TRAN_ID > 0 && model.MD_ID > 0)
                {
                    ...
                    var responseMessage = _partyReceiptVoucherService.GetDataForReport(model, reportDetails, CommonHelper.GetValues(HttpContext));
