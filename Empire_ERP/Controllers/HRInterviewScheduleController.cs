...
namespace Empire_ERP.Controllers
{
    [CheckSession]
    [ExtractMenuCode]
    public class HRInterviewScheduleController : BaseController
    {
        public IHRInterviewScheduleService _HRCandidateService { get; set; }
        private readonly IWebHostEnvironment _hostingEnvironment;
        public IPeriodService _periodService { get; set; }
        public HRInterviewScheduleController(IHRInterviewScheduleService chartOfAccountService, IMenuService menuService, IWebHostEnvironment hostingEnvironment, IPeriodService periodService,IBaseService baseService) : base(menuService,baseService)
        {
            _HRCandidateService = chartOfAccountService;
        ...
        {
            var data = _HRCandidateService.GetHRJobPosts(CommonHelper.GetValues(HttpContext));
            return Json(data);
        }

        //[HttpGet]
        //public JsonResult GetEmpMails()
        //{
        //    var data = _HRCandidateService.GetEmpMails(CommonHelper.GetValues(HttpContext));
        //    return Json(data);
        //}
        ...
        //    try
        //    {
        //        var data = _HRCandidateService.GetAccountsForTreeView(CommonHelper.GetValues(HttpContext));
        //        return Json(data);
        //    }
        //    catch (Exception ex)
        //    {
        ...
        public JsonResult QuickSearch()
        {
            try
            {
                var data = _HRCandidateService.QuickSearch(CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        {
            var data = _HRCandidateService.GetHRJobPostById(id, CommonHelper.GetValues(HttpContext));
            return Json(data);
        }
        ...
        //    try
        //    {
        //        var data = _HRCandidateService.GenerateCardNo(CommonHelper.GetValues(HttpContext));
        //        return Json(data);
        //    }
        //    catch (Exception ex)
        //    {
        ...
        [HttpPost]
        public JsonResult Save(HRInterviewSchedule model)
        {
            try
            {
                var data = _HRCandidateService.Save(model, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult Delete(int id)
        {
            try
            {
                var data = _HRCandidateService.Delete(id, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        //            var responseMessage = _HRCandidateService.GetDataForReport(model, reportDetails, CommonHelper.GetValues(HttpContext));
