...
namespace Empire_ERP.Controllers
{
    ...
    {
        public IBankDetailService _BankDetailService { get; set; }
        public IPeriodService _periodService { get; set; }

        private readonly IWebHostEnvironment _hostingEnvironment;
        public BankDetailController(IBankDetailService BankDetailService, IMenuService menuService, IPeriodService periodService, IWebHostEnvironment hostingEnvironment,IBaseService baseService) : base(menuService,baseService)
        {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.Accounts = _BankDetailService.GetChartOfAccounts(CommonHelper.GetValues(HttpContext));
        ...
        public JsonResult GetBankDetails()
        {
            try
            {
                var data = _BankDetailService.QuickSearch(CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpGet]
        public JsonResult GetBankDetailByCode(int code)
        {
            try
            {
                var data = _BankDetailService.GetBankDetailByCode(code, CommonHelper.GetValues(HttpContext));
                var detailData = _BankDetailService.GetBankDetailDetailByCode(code, CommonHelper.GetValues(HttpContext));
        ...
        [HttpGet]
        public JsonResult GetBankDetailDetailByCode(int code)
        {
            try
            {
                var data = _BankDetailService.GetBankDetailDetailByCode(code, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public JsonResult Save(CustomBankDetail modelRecord)
        {
            try
            {
                var data = _BankDetailService.Save(modelRecord, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult Delete(int code)
        {
            try
            {
                var data = _BankDetailService.Delete(code, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public JsonResult DeleteBankDetailDetailByCode(int code)
        {
            try
            {
                var data = _BankDetailService.DeleteBankDetailDetailByCode(code, CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult GetSodaBookFeedingDetail()
        {
            try
            {
                var data = _BankDetailService.GetSodaBookFeedingDetail(CommonHelper.GetValues(HttpContext));
                return Json(data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> SaveImage()
        {
            ...
            try
            {
                ...
                {
                    string uploadsFolder = Path.Combine(_hostingEnvironment.WebRootPath, "Client" , "uploads", "BankDetail");
                    ...
                    response.msgType = 1;
                    response.data = $"/Client/uploads/BankDetail/{uniqueFileName}"; // Return file path
                }
                else
                {
