var empr_SalesInvoiceReport = {
    ...
    InitEvents() {
        ...
        empr_SalesInvoiceReport.InitSControlDDL();
        empr_SalesInvoiceReport.InitAccountDDL();
        empr_SalesInvoiceReport.InitSalesmanDDL();
        empr_SalesInvoiceReport.InitItemMasterDDL();
        empr_SalesInvoiceReport.InitItemIdDDL();
        empr_SalesInvoiceReport.InitItemGroupDDL();
        empr_SalesInvoiceReport.InitBranchDDL(Branch);
        empr_SalesInvoiceReport.InitCategoryDDL();
        empr_SalesInvoiceReport.InitSubCategoryDDL();
        empr_SalesInvoiceReport.InitBarcodeDDL();
        empr_SalesInvoiceReport.InitColorDDL();
        empr_SalesInvoiceReport.InitSizeDDL();
    ...
    InitSControlDDL(selectedValue) {
        ajaxHelper.ajaxGetJson("/SalesInvoiceReport/GetControlsForSalesman", function (data) {
            if (data.msgType == 1) {
                empr_SalesInvoiceReport.ControlData = data.data;
    ...
    InitSalesmanDDL(selectedValue) {
        ajaxHelper.ajaxGetJson("/SalesInvoiceReport/GetSalesman", function (data) {
            if (data.msgType == 1) {
                empr_SalesInvoiceReport.SalesmanData = data.data;
    ...
    InitReportGrid(dataSrc, reportId) {
        ...
        if (reportId == 18) {
            col = [
                {
                    ...
                    groupCellTemplate: function (element, info) {
                        ...
                        const anchor = $('<a>', {
                            ...
                            click: function (e) {
                                e.preventDefault();
                                empr_SalesInvoiceReport.openVoucherPage(address, traN_ID);
                            }
                        });
                ...
                { dataField: 'itemName', caption: 'Description', width: 250 },
            ...
            col = [
                { dataField: 'voucherDate', caption: 'Date', dataType: 'date', format: 'dd/MM/yyyy', groupIndex: 0 },
                {
                    caption: 'Sno.',
                    cellTemplate: function (container, options) {
        ...
        //        { dataField: 'price', caption: 'Pr.Price', dataType: 'number', width: 120 },
        //        { dataField: 'shopPrice', caption: 'Retail Price', dataType: 'number', width: 120 },
        //        { dataField: 'totalBalance', caption: 'Balance', dataType: 'number', width: 120, },
        //    ];
        //}
        else if (reportId == 35) {
            ...
            col = [
                ...
                { dataField: 'itemName', caption: 'Item', groupIndex: 0 },
                { dataField: 'desc', caption: 'Description', width: 320, },
            ...
            col = [
                { dataField: 'category', caption: 'Category', groupIndex: 0 },
                { dataField: 'sno', caption: 'S.No', width: 60 },
                { dataField: 'itemName', caption: 'Item'},
                //{ dataField: 'subCategory', caption: 'Sub Category' },
                { dataField: 'debit', caption: 'Stock In', dataType: 'number' },
                { dataField: 'credit', caption: 'Stock Out', dataType: 'number' },
            ...
            col = [
                ...
                //    cellTemplate: function (container, options) {
                //        if (options.rowType === 'data') {
                //            if (options.data.category !== options.component.prevGroupValue) {
                //                serialNumber = 1;
                //                options.component.prevGroupValue = options.data.category;
                //            } else {
                //                serialNumber++;
                //            }
                //            container.text(serialNumber);
            ...
            col = [
                ...
                { dataField: 'itemName', caption: 'Item' },
                //{ dataField: 'subCategory', caption: 'Sub Category' },
                { dataField: 'balanceWithTotal', caption: 'Balance', dataType: 'number', width: 100 }
            ];
        }
        else if (reportId == 94) {
            col = [
        ...
        ///add report pos salesman item wise 
            ...
            col = [
                ...
                { dataField: 'rate', caption: 'Rate', width: 120 },
                { dataField: 'amt', caption: 'Amount', width: 120, format: { type: 'fixedPoint', precision: 0 } },
                { dataField: 'disc', caption: 'Disc', width: 120 },
                { dataField: 'mDisc_Amt', caption: 'Disc Amt', width: 120 },
                { dataField: 'tax', caption: 'Tax', width: 120 },
                { dataField: 'taxAmt', caption: 'Tax Amt', width: 120 },
                { dataField: 'adV_TAX', caption: 'Adv Tax', width: 120 },
                { dataField: 'adV_TAX_AMT', caption: 'Adv Tax Amt', width: 120 },
                { dataField: 'netAmt', caption: 'Net Amt', width: 120 },
        ...
        else if (reportId == 34 || reportId == 146) {
            col = [
                { dataField: 'category', caption: 'Account', groupIndex: 0 },
                { dataField: 'itemId', caption: 'Item Name', },
                { dataField: 'barcode', caption: 'Barcode', alignment: 'center', width: 200 },
                {
                ...
                {
                    dataField: 'rate', caption: 'Rate', width: 150,
                    cellTemplate: function (container, options) {
                        var val = options.value;
                        if (val === undefined || val === null || val === 0) {
                            container.text('');
                ...
                {
                    dataField: 'amt', caption: 'Amount', width: 150,
                    cellTemplate: function (container, options) {
                        var val = options.value;
                        if (val === undefined || val === null || val === 0) {
                            container.text('');
                ...
                {
                    dataField: 'shopPrice', caption: 'Sale Price', width: 150,
                    cellTemplate: function (container, options) {
                        var val = options.value;
                        if (val === undefined || val === null || val === 0) {
                            container.text('');
            ...
            col = [
                ...
                { dataField: 'partyName', caption: 'Party Name', width: 250 },
                { dataField: 'itemName', caption: 'Item Name', width: 350 },
                {
                    dataField: 'qty', caption: 'Qty', width: 150,
                    cellTemplate: function (container, options) {
                        var val = options.value;
                ...
                {
                    dataField: 'netAmt', caption: 'Amount', width: 150,
                    cellTemplate: function (container, options) {
                        var val = options.value;
                        if (val === undefined || val === null || val === 0) {
                            container.text('');
                ...
                {
                    dataField: 'pbRate', caption: 'P.Rate', width: 150,
                    cellTemplate: function (container, options) {
                        var val = options.value;
                        if (val === undefined || val === null || val === 0) {
                            container.text('');
                ...
                {
                    dataField: 'pAmt', caption: 'P.Amount', width: 150,
                    cellTemplate: function (container, options) {
                        var val = options.value;
                        if (val === undefined || val === null || val === 0) {
                            container.text('');
                ...
                {
                    dataField: 'neT_PROFIT1', caption: 'Profit / Loss', width: 150,
                    cellTemplate: function (container, options) {
                        var val = options.value;
                        if (val === undefined || val === null || val === 0) {
                            container.text('');
                ...
                {
                    dataField: 'percentage', caption: '%', width: 100,
                    cellTemplate: function (container, options) {
                        var val = options.value;
                        if (val === undefined || val === null || val === 0) {
                            container.text('');
        ...
        ////landscape
        if (reportId == 138 || reportId == 60 || reportId == 137 || reportId == 59 | reportId == 61 || reportId == 62 || reportId == 63 || reportId == 65 || reportId == 125 || reportId == 148) {
            empr_helper.DxGridBindingForReportsWithSetting_Aging('#ReportGridContainer', col, dataSrc, empr_helper.reportName, true);

        } 
        debugger;
        ////potrait
        if (reportId == 34 || reportId == 45 || reportId == 24 || reportId == 27 || reportId == 64 || reportId == 66 || reportId == 63 || reportId == 76 || reportId == 87 || reportId == 88 || reportId == 89 || reportId == 90 || reportId == 142
            || reportId == 65 || reportId == 18 || reportId == 19 || reportId == 20  || reportId == 46 || reportId == 47 || reportId == 48 || reportId == 94 || reportId == 117
            || reportId == 118 || reportId == 132 || reportId == 133 || reportId == 134 || reportId == 135 || reportId == 67 || reportId == 140 || reportId == 141 || reportId == 146) {
        ...
        setTimeout(function () {
            ...
            if (reportId == 34 || reportId == 45 || reportId == 24 || reportId == 27 || reportId == 66 || reportId == 64 || reportId == 62 || reportId == 63 || reportId == 76 || reportId == 87 || reportId == 88 || reportId == 89 || reportId == 90 || reportId == 142 ||
                reportId == 65 || reportId == 18 || reportId == 19 || reportId == 20 || reportId == 46 || reportId == 47 || reportId == 48 || reportId == 94 || reportId == 117
                || reportId == 118 || reportId == 132 || reportId == 133 || reportId == 134 || reportId == 135 || reportId == 67 || reportId == 140 || reportId == 141 || reportId == 146) {
                empr_helper.DxGridBindingForReportsWithSetting_Aging('#ReportGridContainer', col, dataSrc, empr_helper.reportName);
            }
    ...
    InitItemIdDDL(selectedValue) {
        ajaxHelper.ajaxGetJson("/SalesInvoiceReport/GetItemIds", function (data) {
            if (data.msgType == 1) {
                $('#ITEM_ID').dxSelectBox({
                    dataSource: data.data,
                    displayExpr: 'value',
                    ...
                    onValueChanged: function (e) {
                        if (e.value != '' && e.value != null) {
                            ...
                            if (id.length > 0) {
                                var items = empr_SalesInvoiceReport.ItemData;
    ...
    InitCategoryDDL(selectedValue) {
        ajaxHelper.ajaxGetJson("/SalesInvoiceReport/GetCategories", function (data) {
            if (data.msgType == 1) {
    ...
    InitSubCategoryDDL(selectedValue) {
        ajaxHelper.ajaxGetJson("/SalesInvoiceReport/GetSubCategories", function (data) {
            if (data.msgType == 1) {
    ...
    InitBarcodeDDL(selectedValue) {
        ajaxHelper.ajaxGetJson("/SalesInvoiceReport/GetBarcodes", function (data) {
            if (data.msgType == 1) {
                $('#BARCODE').dxSelectBox({
                    //dataSource: data.data,
                    dataSource: {
    ...
    InitColorDDL(selectedValue) {
        ajaxHelper.ajaxGetJson("/SalesInvoiceReport/GetColors", function (data) {
            if (data.msgType == 1) {
                $('#COLOR').dxSelectBox({
                    dataSource: data.data,
                    displayExpr: 'value',
    ...
    InitLotDDL(selectedValue) {
        ajaxHelper.ajaxGetJson("/SalesInvoiceReport/GetLots", function (data) {
            if (data.msgType == 1) {
    ...
    InitSizeDDL(selectedValue) {
        ajaxHelper.ajaxGetJson("/SalesInvoiceReport/GetSizes", function (data) {
            if (data.msgType == 1) {
                $('#SIZE').dxSelectBox({
                    dataSource: data.data,
                    displayExpr: 'value',
