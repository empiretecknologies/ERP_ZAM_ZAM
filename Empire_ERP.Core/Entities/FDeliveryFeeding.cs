...
namespace Empire_ERP.Core.Entities
{
    ...
    public class CustomFDeliveryFeeding
    {
        public FDeliveryFeeding? Master { get; set; }
        public List<FDeliveryFeedingDetail>? Detail { get; set; }
    }
    public class FDeliveryFeedingReport
    {
        public int? TRAN_ID { get; set; }
    ...
    public class CustomFDeliveryFeedingForPrintReport
    {
