...
namespace Empire_ERP.Core.Entities
{
    ...
    public class CustomStockAdjustment
    {
        public StockAdjustment? Master { get; set; }
        public List<StockAdjustmentDetail>? Detail { get; set; }
    }

    public class StockAdjustmentStickerPrint
    {
    ...
    public class StockAdjustmentForPrint
    {
        public DateTime? V_DATE { get; set; }
        public string? VOUCHER_NO { get; set; }
        public string? REF { get; set; }
    ...
    public class CustomStockAdjustmentForPrintReport
    {
        public StockAdjustmentForPrint? Master { get; set; }
