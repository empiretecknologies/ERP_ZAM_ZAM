...
{
    public class FDeliveryFeedingService : IFDeliveryFeedingService
    {
        public IFDeliveryFeedingRepository _deliverFeedingRepository { get; set; }
        public IMenuService _menuService { get; set; }
        public ICompanyService _companyService { get; set; }
        public FDeliveryFeedingService(IFDeliveryFeedingRepository deliverFeedingRepository, IMenuService menuService, ICompanyService companyService)
        {
        ...
        public MyHttpResponseMessage Save(CustomFDeliveryFeeding model, Common common)
        {
        ...
        public MyHttpResponseMessage GetDataForReport(FDeliveryFeedingReport modelRecord, DataTable dataTable, Common common)
        {
            MyHttpResponseMessage response = new MyHttpResponseMessage();
