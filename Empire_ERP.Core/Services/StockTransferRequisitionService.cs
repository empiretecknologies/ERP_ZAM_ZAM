...
{
    public class StockTransferRequisitionService : IStockTransferRequisitionService
    {
        public IStockTransferRequisitionRepository _stockTransferRepository { get; set; }
        public IBranchService _branchService { get; set; }
        public IMenuService _menuService { get; set; }
        public ICompanyService _companyService { get; set; }
        public StockTransferRequisitionService(IStockTransferRequisitionRepository stockTransferRepository, IBranchService branchService, IMenuService menuService, ICompanyService companyService)
        {
        ...
        {
            return _stockTransferRepository.GetStockTransferRequisitionByCode(code, common);
        }

        public MyHttpResponseMessage GetStockTransferRequisitionDetailByCode(int code, Common common)
        {
            return _stockTransferRepository.GetStockTransferRequisitionDetailByCode(code, common);
        }
        ...
        {
            return _stockTransferRepository.DeleteStockTransferRequisitionDetailByCode(code, common);
        }

        public MyHttpResponseMessage GetDataForCartonSticker(List<StockTransferRequisitionStickerPrint> stockData)
        {
