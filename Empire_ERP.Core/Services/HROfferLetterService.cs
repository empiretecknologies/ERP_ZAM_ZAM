...
{
    public class HROfferLetterService : IHROfferLetterService
    {

        public IHROfferLetterRepository _HRInterviewFeedbackRepository { get; set; }
        public IMenuService _menuService { get; set; }
        public ICompanyService _companyService { get; set; }
        public HROfferLetterService(IHROfferLetterRepository chartOfAccountRepository, IMenuService menuService, ICompanyService companyService)
        {
        ...
        public MyHttpResponseMessage Save(HROfferLetter model, Common common)
        {
        ...
        public MyHttpResponseMessage GetDataForReport(HROfferLetterReport modelRecord, DataTable dataTable, Common common)
        {
