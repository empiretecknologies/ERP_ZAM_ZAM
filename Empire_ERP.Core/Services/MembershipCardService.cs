...
namespace Empire_ERP.Core.Services
{
    public class MembershipCardService : IMembershipCardService
    {
        ...
        public IMembershipCardRepository _deliveryFormatRepository { get; set; }
        public IMenuService _menuService { get; set; }
        public ICompanyService _companyService { get; set; }
        public MembershipCardService(IMembershipCardRepository chartOfAccountRepository, IMenuService menuService, ICompanyService companyService)
        {
        ...
        public MyHttpResponseMessage GetMembershipCards(Common common)
        {
            return _deliveryFormatRepository.GetMembershipCards(common);
        }
        ...
        public MyHttpResponseMessage Save(MembershipCard model, Common common)
        {
        ...
        {
            return _deliveryFormatRepository.GenerateCardNo(common);
        }

        public MyHttpResponseMessage GetMembershipCardById(int id, Common common)
        {
            return _deliveryFormatRepository.GetMembershipCardById(id, common);
        }
        ...
        public MyHttpResponseMessage GetDataForReport(MembershipCardReport modelRecord, DataTable dataTable, Common common)
        {
