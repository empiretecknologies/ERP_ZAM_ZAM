...
{
    public class SodaBookFeedingService : ISodaBookFeedingService
    {
        public ISodaBookFeedingRepository _sodaBookFeedingRepository { get; set; }

        public IMenuService _menuService { get; set; }
        public SodaBookFeedingService(ISodaBookFeedingRepository sodaBookFeedingRepository, IMenuService menuService)
        {
        ...
        public MyHttpResponseMessage Save(CustomSodaBookFeeding model, Common common)
        {
