...
{
    public class HRJobPostService : IHRJobPostService
    {

        public IHRJobPostRepository _deliveryFormatRepository { get; set; }
        public IMenuService _menuService { get; set; }
        public ICompanyService _companyService { get; set; }
        public HRJobPostService(IHRJobPostRepository chartOfAccountRepository, IMenuService menuService, ICompanyService companyService)
        {
        ...
        {
            return _deliveryFormatRepository.GetHRJobPosts(common);
        }
        ...
        public MyHttpResponseMessage Save(HRJobPost model, Common common)
        {
        ...
        {
            return _deliveryFormatRepository.GetHRJobPostById(id, common);
        }

        public MyHttpResponseMessage GetEmpMails(Common common)
        {
            return _deliveryFormatRepository.GetEmpMails(common);
        }
        ...
        public MyHttpResponseMessage GetDataForReport(HRJobPostReport modelRecord, DataTable dataTable, Common common)
        {
