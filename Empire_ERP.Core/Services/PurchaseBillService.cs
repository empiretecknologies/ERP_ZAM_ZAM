...
namespace Empire_ERP.Core.Services
{
    ...
    {
        public IPurchaseBillRepository _purchaseBillRepository { get; set; }
        public IMenuService _menuService { get; set; }
        public ICompanyService _companyService { get; set; }
        public PurchaseBillService(IPurchaseBillRepository purchaseBillRepository, IMenuService menuService, ICompanyService companyService)
        {
        ...
        {
            return _purchaseBillRepository.QuickSearch(common);
        }
        ...
        //{
        //    return _purchaseBillRepository.QuickSearch(common, skip, take, filter, group, sort);
        //}

        public MyHttpResponseMessage GetPurchaseBillByCode(int code, Common common)
        {
            return _purchaseBillRepository.GetPurchaseBillByCode(code, common);
        }

        public MyHttpResponseMessage GetPurchaseBillDetailByCode(int code, Common common)
        {
            return _purchaseBillRepository.GetPurchaseBillDetailByCode(code, common);
        }
        public MyHttpResponseMessage GetPurchaseBillCommissionByCode(int code, Common common)
        {
            return _purchaseBillRepository.GetPurchaseBillCommissionByCode(code, common);
        }

        public MyHttpResponseMessage GetPickDataByParty(int partyCode, int actCode, Common common)
        {
            return _purchaseBillRepository.GetPickDataByParty(partyCode, actCode, common);
        }
        ...
        {
            return _purchaseBillRepository.GetPurchaseBillPickDetailByCode(code, common);
        }

        public MyHttpResponseMessage GetPurchaseBillDetailByItem(int code, int qty,decimal?disc, Common common)
        {
            return _purchaseBillRepository.GetPurchaseBillDetailByItem(code, qty,disc, common);
        }

        public MyHttpResponseMessage Save(CustomPurchaseBill modelRecord, Common common)
        {
            return _purchaseBillRepository.Save(modelRecord, common);
        }

        public MyHttpResponseMessage Delete(int code, Common common)
        {
            return _purchaseBillRepository.Delete(code, common);
        }
        public MyHttpResponseMessage GetAvailableStock(string? period, Common common)
        {
            return _purchaseBillRepository.GetAvailableStock(period, common);
        }
        public MyHttpResponseMessage GetLastRateByBarcode(CustomPurchaseBill model,string? dcType, Common common)
        {
            return _purchaseBillRepository.GetLastRateByBarcode(model, dcType, common);
        }
        ...
        public MyHttpResponseMessage CopyRecord(CopyRecord record, Common common)
        {
            ...
            try
            {
                ...
                if (!String.IsNullOrWhiteSpace(table))
                {
                    ...
                    {
                        response = _purchaseBillRepository.CopyRecord(record, common, menu);
                    }
                }
                else
                {
        ...
        {
            return _purchaseBillRepository.DeletePurchaseBillDetailByCode(code, common);
        }
        public MyHttpResponseMessage DeleteCommDetailByCode(int code, Common common)
        {
            return _purchaseBillRepository.DeleteCommDetailByCode(code, common);
        }

        public MyHttpResponseMessage GetDataForReport(PurchaseBillRDLCReport modelRecord, DataTable dataTable, DataTable taxDataTable, DataTable inspectionServiceChargesDetails, DataTable reportDetailsDDJ, Common common)
        {
            MyHttpResponseMessage response = new MyHttpResponseMessage();
            ...
            try
            {
                ...
                return _purchaseBillRepository.GetDataForReport(modelRecord, dataTable, taxDataTable, inspectionServiceChargesDetails, reportDetailsDDJ, menuDetail, currentCompany, common);
            }
            catch (Exception ex)
            {
                string _catchMessage = ex.Message;
