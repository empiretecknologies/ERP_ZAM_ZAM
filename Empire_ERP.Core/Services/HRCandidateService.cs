...
namespace Empire_ERP.Core.Services
{
    public class HRCandidateService : IHRCandidateService
    {
        ...
        public IHRCandidateRepository _HRCandidateRepository { get; set; }
        public IMenuService _menuService { get; set; }
        public ICompanyService _companyService { get; set; }
        public HRCandidateService(IHRCandidateRepository chartOfAccountRepository, IMenuService menuService, ICompanyService companyService)
        {
        ...
        public MyHttpResponseMessage Save(HRCandidate model, Common common)
        {
