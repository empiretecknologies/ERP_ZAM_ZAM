...
{
    public interface IHRJobPostRepository
    {
        ...
        MyHttpResponseMessage Save(HRJobPost model, Common common);
        ...
        MyHttpResponseMessage GetDataForReport(HRJobPostReport modelRecord, DataTable details, CustomMenuDetail menuDetails, Company currentCompany, Common common);
    }
}
