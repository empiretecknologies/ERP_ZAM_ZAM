...
namespace Empire_ERP.Core.Interfaces
{
    ...
    {
        MyHttpResponseMessage GetGatePasss(Common common);
        ...
        MyHttpResponseMessage GetGatePassById(int id, Common common);
        MyHttpResponseMessage Save(GatePass model, Common common);
        ...
        MyHttpResponseMessage GetDataForReport(GatePassReport modelRecord, DataTable details, CustomMenuDetail menuDetails, Company currentCompany, Common common);
    }
}