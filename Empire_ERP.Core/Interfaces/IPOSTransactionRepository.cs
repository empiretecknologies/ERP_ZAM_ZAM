...
namespace Empire_ERP.Core.Interfaces
{
    public interface IPOSTransactionRepository
    {
        ...
        MyHttpResponseMessage Save(CustomPOSTransaction model, CustomMenuDetail menuDetails ,  Common common , Company currentCompany , Branch currentBranch , Info currentLabel);
        ...
        MyHttpResponseMessage GetDataForReport(POSPrint_Model modelRecord, CustomMenuDetail menuDetails, Info currentLabel , Branch currentBranch , Company currentCompany, POSMapping currentMapping, Common common);
        MyHttpResponseMessage ExpensePrintReport(List<ExpensePrint> expenses, Info currentLabel, Branch currentBranch, Company currentCompany, Common common);
