...
{
    public interface IFDeliveryFeedingRepository
    {
        ...
        MyHttpResponseMessage Save(CustomFDeliveryFeeding model, Common common);
        ...
        MyHttpResponseMessage GetDataForReport(FDeliveryFeedingReport modelRecord, DataTable details, CustomMenuDetail menuDetails, Company currentCompany, Common common);
    }
}