...
{
    public interface IMerchantPurchaseOrderRepository
    {
        ...
        MyHttpResponseMessage GetDataForReport(MerchantPurchaseOrderReport modelRecord, CustomMenuDetail menuDetails, Company currentCompany, Common common);
    }
}
