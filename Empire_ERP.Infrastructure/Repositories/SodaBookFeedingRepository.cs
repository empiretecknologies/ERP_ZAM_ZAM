...
{
    public class SodaBookFeedingRepository : ISodaBookFeedingRepository
    {
        ...
        public SodaBookFeedingRepository(IMenuRepository menuRepository, IBranchRepository branchRepository, IPartyRepository partyRepository, ICommonRepository commonRepository)
        {
        ...
        public MyHttpResponseMessage Save(CustomSodaBookFeeding modelRecord, Common common)
        {
            MyHttpResponseMessage response = new MyHttpResponseMessage();
            try
            {
                        ...
                        try
                        {
                            ...
                            if (modelRecord.Master.TRAN_ID == null || modelRecord.Master.TRAN_ID == 0)
                            {
                                ...
                                query = $"INSERT INTO {table}" +
                                        ...
                                        "DLT, CREDIT_DAYS, DUE_DATE, SBF_TYPE, CURR_CODE, UNIT, CRATE, SHIP_DATE, SHIP_STATUS, P_SHIP, TRANS_PS, P_S, SODA_TYPE, COB_CODE, COB_ACODE)" +
                                        "VALUES" +
                                        ...
                                        "'" + modelRecord.Master.CRATE + "','" + modelRecord.Master.SHIP_DATE + "','" + modelRecord.Master.SHIP_STATUS + "','" + modelRecord.Master.P_SHIP + "','" + modelRecord.Master.TRANS_PS + "','" + modelRecord.Master.P_S + "'," +
                                        "'" + modelRecord.Master.SODA_TYPE + "','" + modelRecord.Master.COB_CODE + "','" + modelRecord.Master.COB_ACODE + "')";
                ...
                if (!String.IsNullOrWhiteSpace(table))
                {
                    ...
                    using (SqlConnection connection = new SqlConnection(new SQLService().getconnstring()))
                    {
                        string query = "SELECT TRAN_ID, P_S, P_SHIP, TRANS_PS, SODA_TYPE, V_DATE, VOUCHER_NO," +
                                       "SELLER_CODE, SACT_CODE, BUYER_CODE, BACT_CODE, REF, REMARKS, COND, BROKER_CODE, BD_ACT_CODE, ASTATUS, CREDIT_DAYS, DUE_DATE, SBF_TYPE, CURR_CODE, UNIT, CRATE, SHIP_DATE, SHIP_STATUS " +
        ...
        public MyHttpResponseMessage CopyRecord(CopyRecord record, Common common, Menu menu)
        {
            ...
            try
            {
                ...
                SodaBookFeeding sodaBookFeeding = new SodaBookFeeding();
                List<SodaBookFeedingDetail> sodaBookFeedingDetailList = new List<SodaBookFeedingDetail>();
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    if (reader.Read())
                    {
                        sodaBookFeeding = new SodaBookFeeding
                        {
                    ...
                    {
                        var row = new SodaBookFeedingDetail
                        {
                ...
                var customRequisition = new CustomSodaBookFeeding
                {
