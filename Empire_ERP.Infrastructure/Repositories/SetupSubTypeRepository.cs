...
{
    public class SetupSubTypeRepository : ISetupSubTypeRepository
    {
        public IMenuRepository _menuRepository { get; set; }
        public SetupSubTypeRepository(IMenuRepository menuRepository)
        {
        ...
        public MyHttpResponseMessage QuickSearch(Common common)
        {
            ...
            try
            {
                ...
                if (!String.IsNullOrWhiteSpace(table))
                {
                    ...
                    {
                        string query = "SELECT GROUP_CODE,GROUP_NAME,GPIC,ADD_USER_ID," +
        ...
        public MyHttpResponseMessage Save(SetupSubType modelRecord, Common common)
        {
            MyHttpResponseMessage response = new MyHttpResponseMessage();
            try
            {
        ...
        public MyHttpResponseMessage GetSetupSubTypeById(int id, Common common)
        {
            ...
            try
            {
                ...
                if (!String.IsNullOrWhiteSpace(table))
                {
                    using (SqlConnection connection = new SqlConnection(new SQLService().getconnstring()))
                    {
                        string query = "SELECT GROUP_CODE,GROUP_NAME,GPIC,ASTATUS " +
                                       "FROM " + table + " " +
